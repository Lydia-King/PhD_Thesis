...
% OS using PAM50 Subtype and the 6 CNA Burden metrics as candidate predictors
\begin{figure}[!htb]
\centering
...
% OS using IntClust and the 6 CNA Score metrics as candidate predictors
\begin{figure}[!htb]
\centering
...
% OS using IntClust and the 6 CNA Burden metrics as candidate predictors
\begin{figure}[!htb]
\centering
...
% OS using PAM50 Subtype, the 6 CNA Burden metrics and a number of clinical variables as candidate predictors
\begin{figure}[!htb]
\centering
