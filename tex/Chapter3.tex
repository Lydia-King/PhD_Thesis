...
\begin{table}[!htb]
\caption[Association tests between CNA Quartiles and selected clinical variables.]{Association tests between CNA Quartiles and selected clinical variables. Chi-Squared, Fisher's Exact and Kruskal-Wallis test p-values and Benjamini-Hochberg adjusted p-values are displayed.}
...
\begin{table}[!htb]
\tiny
\caption[Final multivariable CPH model for DSS (Absolute CNA Score Quartiles).]{Final multivariable CPH model for DSS. Including selected clinical variables, Absolute CNA Score Quartiles and an interaction term, within the Luminal METABRIC cohort.}
\centering
\resizebox{\textwidth}{!}{ 
...
\begin{table}[!htb]
\tiny
\caption[Final multivariable CPH model for DSS (Absolute CNA Score).]{Final multivariable CPH model for DSS. Including selected clinical variables, Absolute CNA Score and an interaction term, within the Luminal METABRIC cohort.}
\centering
\resizebox{\textwidth}{!}{ 
    \begin{tabular}{lccccl}
    \hline
...
\captionsetup[subfigure]{font={bf,small}, skip=1pt, margin=-0.0cm, singlelinecheck=false}
